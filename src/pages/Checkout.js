                        ...
                        <div className="checkout-left-data">
                            ...
                            >
                                <ol className="breadcrumb">
                                    ...
                                    &nbsp; /
                                    <li className="breadcrumb-item partial-price active">Information</li>
                                    &nbsp; /
                                    <li className="breadcrumb-item partial-price active">Shipping</li>
                                    &nbsp; /
                                    <li className="breadcrumb-item partial-price active" aria-current="page">Payment</li>
                                </ol>
                            </nav>
                            <h4 className="title total">Contact Information</h4>
                            <p className="user-details">
                                John Doe (johndoe101@gmail.com)
                            </p>
                    ...
                    <div className="col-5">
                        <div className="border-bottom py-4 d-flex flex-column gap-30">
                            <div className="d-flex justify-content-between gap-10 align-items-center">
                                <div className="w-75 d-flex gap-15">
                                    <div className="w-25 position-relative">
                                        <span className="checkout-product-number-badge badge">1</span>
                                        <img src={watch} className='img-fluid' alt="product" />
                                    </div>
                                    <div className="d-flex flex-column justify-content-center">
                                        <h5 className="total">Kids headphones bulk 10 pack multi colored for students</h5>
                            ...
                            <div className="d-flex justify-content-between gap-10 align-items-center">
                                <div className="w-75 d-flex gap-15">
                                    <div className="w-25 position-relative">
                                        <span className="checkout-product-number-badge badge">6</span>
                                        <img src={watch} className='img-fluid' alt="product" />
                                    </div>
                                    <div className="d-flex flex-column justify-content-center">
                                        <h5 className="total">Kids headphones bulk 10 pack multi colored for students </h5>
